...
<form>
	...
	<router-link to="/Display"><button type="submit" class="btn btn-primary" @click="setValue">Submit</button></router-link>
</form>
...
export default{
	...
	methods:{
		setValue(){
            ...
            localStorage.setItem('id1',JSON.stringify(this.parr));
		}
	}
}
</script>
